...
#define FILE_NAME "./data/datos_historicos_trafo_1.csv"
//Solo faltan 5 transformadores. [1,7,15,23,39]
std::string CONFIG = "10111111";
...
#define CNT_PRUEBAS 7

/*condiciones de parada */
#define ERROR_TO_STOP 0.01
...
#define NUM_MIN_INSTRUCTIONS (3)
#define NUM_MAX_INSTRUCTIONS (30)
#define NUM_INI_INSTRUCTIONS (5)
#define NUM_OPERATORS 9


#define NUM_VAR_REGISTER 10//K
...
#define CONST_IN_DELTA_MIN CONST_IN_MAX + 0 // if DELTA > 0(CONST_IN_MAX + 1)
...
#define NUM_GENERATIONS NUM_MAX_GENERATION
#define POPULATION_SIZE 262144 //460000//262144 //18
#define DEMES 16
#define FREQ_STATS 100
#define POOL_SIZE 4//32
#define POOL_REPRODUCTION 1 //4
#define MIGRATION_RATE 0.005
